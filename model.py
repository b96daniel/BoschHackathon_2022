...
class CameraData:
    ...
    def __str__(self):
        return "CameraData("+"dx="+str(self.dx)+"; dy="+str(self.dy)+"; vx="+str(self.vx)+"; vy="+str(self.vy)+"; type="+str(self.type)+")"
...
class CornerData:
    ...
    def __str__(self):
        return "CornerData("+"dx="+str(self.dx)+"; dy="+str(self.dy)+"; vx="+str(self.vx)+"; vy="+str(self.vy) \
...
class VehicleData:
    ...
    def __str__(self):
        return "VehicleData("+"t=" + str(self.t) + "; vx="+str(self.vx)+"; vy="+str(self.vy) +"; ax="+str(self.ax)+"; ay="+str(self.ay)+"; yaw="+str(self.yaw_rate)+")"
...
class GpsData:
    ...
    def __str__(self):
        return "GpsData("+"t="+str(self.t)+"; dx="+str(self.dx)+"; dy="+str(self.dy)+"; vx="+str(self.vx)+"; vy="+str(self.vy)+ ")"
